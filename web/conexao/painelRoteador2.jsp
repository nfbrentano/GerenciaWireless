<%-- Document : painelRoteador Created on : Jun 15, 2018, 1:29:24 PM Author : natan --%>
                                                    ...
                                                    <%@page import="java.sql.Statement" %>
                                                        <%@page import="java.sql.DriverManager" %>
                                                            <%@page import="java.sql.Connection" %>
                                                                <%-- Para poder utilizar a jstl é necessário adicionar o
                                                                    respectivo .jar nas bibliotecas --%>
                                                                    <%@ taglib uri="http://java.sun.com/jsp/jstl/core"
                                                                        ...
                                                                        <body onload="document.formTeste.nome.focus()">
                                                                            ...
                                                                            <% try { service.RoteadorService
                                                                                roteadorService=new
                                                                                service.RoteadorService();
                                                                                request.setAttribute("listaRoteadores",
                                                                                roteadorService.listar()); } catch
                                                                                (Exception e) { out.write("<p
                                                                                class='text-danger'>Erro ao carregar
                                                                                roteadores: " + e.getMessage() + "</p>
                                                                                ");
                                                                                }
                                                                                %>
                                                                                ...
                                                                                <%@ include file="nav.jsp" %>
                                                                                    ...
                                                                                    <div class="container">
                                                                                        <form class="form-horizontal"
                                                                                            role="form" method="post" a>

                                                                                            <h2
                                                                                                class="card-title mt-3 text-center">
                                                                                                Painel de Roteador</h2>
                                                                                            ...
                                                                                            <% try { // Registrar o
                                                                                                ...
                                                                                                // Conectar o banco
                                                                                                Connection
                                                                                                conn=DriverManager.getConnection("jdbc:postgresql://localhost:5432/cadastroweb", "postgres"
                                                                                                , "postgres" ); //
                                                                                                Statement para executar
                                                                                                os comandos sql
                                                                                                Statement
                                                                                                st=conn.createStatement();
                                                                                                String
                                                                                                query="SELECT * FROM pontoacesso WHERE disponibilidade = true AND ssid = 'Analise'"
                                                                                                ; ResultSet
                                                                                                rs=st.executeQuery(query);
                                                                                                rs.next(); { String
                                                                                                iproteador=rs.getString("iproteador");
                                                                                                String
                                                                                                ...
                                                                                                acabou"); try {
                                                                                                VarbindCollection
                                                                                                result=context.getNext("sysUpTime").get();
                                                                                    ...
                                                                                    <% } catch (Exception e) {
                                                                                        out.write("Ocorreu um erro ao
                                                                                        buscar o registro: <span
                                                                                        style='color: red'>" +
                                                                                        e.getMessage() + "</span>");
                                                                                        }
                                                                                        %>
