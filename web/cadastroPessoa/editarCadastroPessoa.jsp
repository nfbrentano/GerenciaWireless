<%-- Document : editarCadastroPessoa Created on : Mar 25, 2018, 8:26:20 PM Author : natan --%>
                                        ...
                                        <%@page import="dao.CidadeDao" %>
                                            <%@page import="dao.BairroDao" %>
                                                <%@page import="model.Pais" %>
                                                    <%-- Para poder utilizar a jstl é necessário adicionar o respectivo
                                                        .jar nas bibliotecas --%>
                                                        <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
                                                            ...
                                                            <body onload="document.formTeste.nome.focus()">
                                                                ...
                                                                <% try { request.setAttribute("listaPaises", new
                                                                    ...
                                                                    service.RoteadorService().listar()); String
                                                                    cod=request.getParameter("cod"); if (cod !=null) {
                                                                    service.CadastroPessoaService servico=new
                                                                    service.CadastroPessoaService();
                                                                    model.CadastroPessoa
                                                                    pessoa=servico.getById(Integer.parseInt(cod));
                                                                    request.setAttribute("p", pessoa); } } catch
                                                                    (Exception e) { out.write("<p class='text-danger'>
                                                                    Erro: " + e.getMessage() + "</p>");
                                                                    }
                                                                    %>
                                                                    ...
                                                                    <%@ include file=" nav.jsp" %>
                                                                            ...
                                                                            <form class="form-horizontal" role="form"
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="col-sm-9">
                                                                                        <input class="form-control"
                                                                                            type="text" required="true"
                                                                                            name="nome" maxlength="45"
                                                                                            size="50" value='${p.nome}'>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <label for="sobrenome"
                                                                                        class="col-sm-1 control-label">Sobrenome:</label>
                                                                                    <div class="col-sm-9">
                                                                                        <input class="form-control"
                                                                                            type="text" required="true"
                                                                                            name="sobrenome"
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label for="documento"
                                                                                        class="col-sm-1 control-label">Documento:</label>
                                                                                    <div class="col-sm-9">
                                                                                        <input class="form-control"
                                                                                            type="text"
                                                                                            ...
                                                                                            required="true"
                                                                                            name="documento"
                                                                                            maxlength="14" size="50"
                                                                                            value='${p.documento}'>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <label for="pais"
                                                                                        class="col-sm-1 control-label">País:</label>
                                                                                    <div class="col-sm-9">
                                                                                        <input class="form-control"
                                                                                            type="text" required="true"
                                                                                            list="paises" maxlength="45"
                                                                                            name="pais" size="50"
                                                                                            value='${p.pais}'>
                                                                                        <datalist id="paises">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label for="estado"
                                                                                        class="col-sm-1 control-label">Estado:</label>
                                                                                    <div class="col-sm-9">
                                                                                        <input class="form-control"
                                                                                            type="text" required="true"
                                                                                            list="estados" name="estado"
                                                                                            maxlength="45" size="50"
                                                                                            required
                                                                                            value='${p.estado}'>
                                                                                        <datalist id="estados">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label for="bairro"
                                                                                        class="col-sm-1 control-label">Bairro:</label>
                                                                                    <div class="col-sm-9">
                                                                                        <input class="form-control"
                                                                                            type="text" required="true"
                                                                                            list="bairros" name="bairro"
                                                                                            maxlength="45" size="50"
                                                                                            required
                                                                                            value='${p.bairro}'>
                                                                                        <datalist id="bairros">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label for="numero"
                                                                                        class="col-sm-1 control-label">Número:</label>
                                                                                    <div class="col-sm-9">
                                                                                        <input class="form-control"
                                                                                            type="text"
                                                                                            onkeyup="somenteNumeros(this);"
                                                                                            ...
                                                                                            maxlength="14" size="50"
                                                                                            required
                                                                                            value='${p.numeroendereco}'>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <label for="usuario"
                                                                                        class="col-sm-1 control-label">Usuário:</label>
                                                                                    <div class="col-sm-9">
                                                                                        <input class="form-control"
                                                                                            type="text"
                                                                                            name="nomeusuario"
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label for="senha"
                                                                                        class="col-sm-1 control-label">Senha:
                                                                                    </label>
                                                                                    <div class="col-sm-9">
                                                                                        <input class="form-control"
                                                                                            type="text"
                                                                                            name="senhaacesso"
                                                                                            maxlength="32" size="50"
                                                                                            value='${p.senhaacesso}'>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <label for="pontoacesso"
                                                                                        class="col-sm-1 control-label">Roteador:
                                                                                    </label>
                                                                                    <div class="col-sm-9">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <div
                                                                                        ...
                                                                                        <button type="submit"
                                                                                            ...
                                                                                            name="enviar"
                                                                                            onclick="validaFormCadastroPessoa()">Atualizar</button>
                                                                                        <button type="reset"
                                                                                            class="btn btn-primary btn-block"
                                                                                            name="limpar">Limpar</button>
                                                                                        <a class="btn btn-primary btn-block"
                                                                                            href="<%=request.getContextPath()%>/cadastroPessoa/listarCadastroPessoa.jsp"
                                                                        ...
                                                                        <% } catch (Exception e) { out.write("Ocorreu um
                                                                            erro ao buscar o registro: <span
                                                                            style='color: red'>" +
                                                                            e.getMessage() +
                                                                            "</span>");
                                                                            }
