<%-- 
    ...
    Created on : Jun 7, 2018, 1:25:02 PM
    Author     : natan
--%>
        ...
        <div class="main-content">
            ...
            <%
                try {
                    ...
                    String query = "SELECT max(idendereco+1) FROM endereco";
            ...
            <div class="container">
                <form data-abide="ajax" id="order_form" class="form-horizontal" role="form" method="post" action="incluir_endereco.jsp">

                    <h2 class="card-title mt-3 text-center">Cadastro de Rua</h2>

                    <div class="form-group">
                        <label for="cod" class="col-sm-1 control-label">Código: </label>
                        <div class="col-sm-9">
                            <input class="form-control" type="text"  id="cod" name="idendereco" maxlengt=10 readonly="true" size="50"  value='<%= rs.getString("max")%>'>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-9">
                            ...
                            <datalist id="bairros">
                                ...
                                <c:forEach items="${listaBairros}" var="bairro">
                                    <option value="${bairro.idbairro}">${bairro.nome}</option>
                                </c:forEach>
