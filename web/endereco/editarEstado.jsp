<%-- 
    ...
    Created on : Jun 7, 2018, 10:40:11 AM
    Author     : natan
--%>
        ...
        <div class="main-content">
            ...
            <%
                try {
                    ...
                    String query = "SELECT idestado, nome, sigla, pais_idpais FROM estado WHERE idestado = " + request.getParameter("cod");
            ...
            <div class="container">
                <form data-abide="ajax" id="order_form" class="form-horizontal" role="form" method="post" action="alterarEstado.jsp">         
                    <h2 class="card-title mt-3 text-center">Alterar Estado</h2>

                    <div class="form-group">
                        <label for="cod" class="col-sm-1 control-label">Código:</label>
                        <div class="col-sm-9">
                            <input class="form-control" type="text" size="50" required="true" name="idestado" readonly="true" value='<%= rs.getInt("idestado")%>'>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" type="text" size="50" required="true" name="sigla" maxlenght=80 value='<%= rs.getString("sigla")%>'>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="codpais" class="col-sm-1 control-label">Código da País:   </label>
                        <div class="col-sm-9">
                            <input class="form-control" type="text" size="50" onkeyup="somenteNumeros(this);"  required="true" list="paises" name="pais_idpais" maxlenght=10 value='<%= rs.getString("pais_idpais")%>'>
                            <datalist id="paises">
                    ...
                    <div class="form-group">
                        <div class="col-sm-9 col-sm-offset-1">
                            <button type="submit" class="btn btn-primary btn-block" name="enviar"  onclick="validaFormEstado()">Atualizar</button>
                            <a class="btn btn-primary btn-block" href="<%=request.getContextPath()%>/endereco/listarEstados.jsp" name="voltar" >Voltar</a>
                        </div>
