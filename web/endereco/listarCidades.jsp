                        ...
                        <%@page contentType="text/html" pageEncoding="UTF-8" %>
                                ...
                                <script>
                                    ...
                                    < !--Função javascript para chamar Servlet de exclusão de registro-- >
                                        function excluirRegistroCidade(idcidade, nome) {
                                            if (confirm('Confirma exclusão do cidade de código: ' + idcidade + ' - Nome: ' +
                                                nome + '?')) {
                                                window.location.href = "<%=request.getContextPath()%>/ExcluirCidade?cod=" +
                                                    idcidade;
                                            } else {
                                ...
                                <form name="formTeste" class="form-register1">
                                    ...
                                    <%@ include file="nav.jsp" %>
                                        ...
                                        <form id="custom-search-form" class="form-search form-horizontal pull-right"
                                            name="frmLocalizar" action="listarCidades.jsp" method="POST">
                                            <div class="panel-body">
                                                <div class="input-group">

                                                    <input class="form-control" placeholder="Buscar pelo nome..."
                                                        type="text" name="localizaCidade" value="">
                         ...
                         Cada linha da tabela apresentará um registro da tabela "clientes" -->
                                                <% try { // Conectar o banco usando o utilitário padronizado Connection
                                                    ...
                                                    query="SELECT idcidade, nome, estado_idestado FROM cidade WHERE disponibilidade = true "
                                                    ; String localizarValor=request.getParameter("localizaCidade"); if
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center"> <a class='btn btn-info btn-xs'
                                                                onclick="editarRegistroCidade(<%= rs.getInt("
                                                                idcidade")%>);"><span
                                                                    class="glyphicon glyphicon-edit"></span> Editar</a>
                                                        </td>
                                                        <td class="text-center"> <a class='btn btn-danger btn-xs'
                                                                onclick="excluirRegistroCidade(<%= rs.getInt("
                                                                idcidade")%>, '<%= rs.getString("nome")%>');"><span
                                                                        class="glyphicon glyphicon-remove"></span>
                                                                    Del</a></td>

                                                    </tr>
                                                    <% } // Fim do while } } } catch (Exception e) { out.write("Ocorreu
                                                        um erro ao buscar as cidades <span style='color: red'>" +
                                                        e.getMessage() + "</span>");
                                                        }
                                                        } catch (Exception e) {
