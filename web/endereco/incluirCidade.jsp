<%-- Document : incluirCidade Created on : Jun 7, 2018, 11:40:32 AM Author : natan --%>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="col-sm-9 col-sm-offset-1">
                                                                                    <button type="submit"
                                                                                        ...
                                                                                        name="enviar"
                                                                                        onclick="validaFormCidade()">Registrar</button>
                                                                                    <button type="reset"
                                                                                        class="btn btn-primary btn-block"
