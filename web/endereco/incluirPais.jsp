<%-- Document : incluirPais Created on : Jun 7, 2018, 1:48:34 PM Author : natan --%>
                                            ...
                                            <%@page contentType="text/html" pageEncoding="UTF-8" %>
                                                ...
                                                <body onload="document.formTeste.nome.focus()">
                                                    ...
                                                    <div class="main-content">
                                                        ...
                                                        <% try { int proximoId=0; try (java.sql.Connection
                                                            conn=util.Db.getConexao(); java.sql.Statement
                                                            st=conn.createStatement(); java.sql.ResultSet
                                                            rs=st.executeQuery("SELECT COALESCE(max(idpais), 0) + 1 FROM
                                                            pais")) { if (rs.next()) { proximoId=rs.getInt(1); } }
            ...
            <%@ include file = " nav.jsp"%>
                                                            ...
                                                            <div class="container">
                                                                <form data-abide="ajax" id="order_form"
                                                                    ...
                                                                    action="<%=request.getContextPath()%>/PaisController">


                                                                    <h2 class="card-title mt-3 text-center">Cadastro de
                                                                        País</h2>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                            <input class="form-control" type="text"
                                                                                id="cod" name="idpais" maxlengt=10
                                                                                readonly="true" value='${proximoId}'>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="col-sm-9 col-sm-offset-1">
                                                                            <button type="submit"
                                                                                ...
                                                                                name="enviar"
                                                                                onclick="validaFormPais()">Registrar</button>
                                                                            <button type="reset"
                                                                                class="btn btn-primary btn-block"
